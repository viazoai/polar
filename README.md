...
- **모바일 우선**: 스마트폰에서 주로 사용, PWA로 앱처럼 설치 가능
...
1. ~~**환경 구축 및 뼈대**~~ ✅ — Docker, FastAPI, React + shadcn/ui 초기 세팅 + 업로드/EXIF/썸네일
2. **모바일 우선 리스트 뷰** — 하단 탭 바, 타임라인 UI, 전체화면 상세 Sheet
3. **갤러리 뷰 + PWA** — 폴라로이드 디자인, scroll-snap, Service Worker, 홈 화면 추가
